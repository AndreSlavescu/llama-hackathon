...
class TextGenerator:
    ...
    def get_or_create_conversation(self, session_id: str, max_messages: int = 5) -> ConversationHistory:
        """Get an existing conversation or create a new one"""
        if session_id not in self.conversations:
            self.conversations[session_id] = ConversationHistory(max_messages=max_messages)
...
if __name__ == "__main__":
    ...
    print("Lex: Let's start with a fundamental question - what is consciousness and how does it relate to artificial intelligence?")
    print("Assistant:", generator.chat("Let's start with a fundamental question - what is consciousness and how does it relate to artificial intelligence?", session_id))
    ...
    print("Assistant:", generator.chat("That's fascinating. When you think about the development of AGI, what are the key ethical considerations we need to keep in mind?", session_id))
    print("\nLex: You mentioned alignment. How do we ensure AI systems remain aligned with human values as they become more capable?")
    print("Assistant:", generator.chat("You mentioned alignment. How do we ensure AI systems remain aligned with human values as they become more capable?", session_id))
